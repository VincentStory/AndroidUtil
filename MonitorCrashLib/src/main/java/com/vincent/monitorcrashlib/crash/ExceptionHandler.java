...
public abstract class ExceptionHandler {
    ...
    /**
     * 当原本导致app崩溃的主线程异常发生后，主线程再次抛出导致app崩溃异常时会调用该方法。
     * 自己try catch住的异常不会导致app崩溃，该方法中到的throwable不会上报到bugly，也无需上报到bugly，
     * 因为本次异常可能是由于第一次主线程异常时app没有崩溃掉才发生的，只要修复了bug就不会发生该异常了)
