package com.vincent.monitorcrashlib.crash.compat;
...
public class ActivityKillerV21_V23 implements IActivityKiller {
    ...
    private void finish(IBinder binder) throws Exception {
        ...
        Method finishActivityMethod = activityManager.getClass().getDeclaredMethod(
                "finishActivity", IBinder.class, int.class, Intent.class, boolean.class);
        finishActivityMethod.invoke(activityManager,
