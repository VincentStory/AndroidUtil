...
import com.vincent.monitorcrashlib.BuildConfig;
import com.vincent.monitorcrashlib.R;
import com.vincent.monitorcrashlib.bean.CrashBean;
import com.vincent.monitorcrashlib.crash.CrashHandler;
import com.vincent.monitorcrashlib.crash.ToolAppManager;
...
public final class CrashFileUtils {
    ...
    private static void uploadExceptionToServer(Throwable ex) {
        ...
        crashBean.setCrashName(ex.toString());
        crashBean.setStackTrace(stringBuilder.toString());



        System.out.println("异常信息----" + crashBean);
    }
    ...
    private static void initCrashHead(Context context) {
        ...
        sb.append("\n软件App的Id:").append(BuildConfig.LIBRARY_PACKAGE_NAME);
...
//            }
    ...
    public static void saveCrashInfoToFile(Context context, Throwable ex) {
        ...
        //程序信息
        sb.append("\nAPPLICATION_ID:").append(BuildConfig.LIBRARY_PACKAGE_NAME);//软件APPLICATION_ID
